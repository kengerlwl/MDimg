...
## 首先，去github新建仓库
![](https://i.imgur.com/VXFAdJ6.png)
## 新建python文件以及需要进行换源的文档
![](https://i.imgur.com/bfKFukZ.png)
py文件代码如下：
...
![](https://i.imgur.com/t7u2aK7.png)


查看运行后的md
![](https://i.imgur.com/IQZHsl3.png)
可以发现，已经换成github了

## 然后将github push上去

![](https://i.imgur.com/D0PsiaM.png)

## 查看生成的文档：
![](https://i.imgur.com/tZD4RXW.png)
成功
